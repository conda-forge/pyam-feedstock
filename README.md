...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3198&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyam-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyam` can be installed with `conda`:
...
It is possible to list all of the versions of `pyam` available on your platform with `conda`:
...
```
mamba search pyam --channel conda-forge
```
...
mamba repoquery search pyam --channel conda-forge

# List packages depending on `pyam`:
mamba repoquery whoneeds pyam --channel conda-forge

# List dependencies of `pyam`:
mamba repoquery depends pyam --channel conda-forge
```
